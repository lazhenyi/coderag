...
pub fn rust_config() -> LanguageConfig {
    LanguageConfig {
        language: Language::Rust, name: "Rust".to_string(),
...
pub fn python_config() -> LanguageConfig {
    LanguageConfig {
        language: Language::Python, name: "Python".to_string(),
...
pub fn javascript_config() -> LanguageConfig {
    LanguageConfig {
        language: Language::JavaScript, name: "JavaScript".to_string(),
...
pub fn typescript_config() -> LanguageConfig {
    LanguageConfig {
        language: Language::TypeScript, name: "TypeScript".to_string(),
...
pub fn java_config() -> LanguageConfig {
    LanguageConfig {
        language: Language::Java, name: "Java".to_string(),
...
pub fn go_config() -> LanguageConfig {
    LanguageConfig {
        language: Language::Go, name: "Go".to_string(),
...
pub fn c_config() -> LanguageConfig {
    LanguageConfig {
        language: Language::C, name: "C".to_string(),
...
pub fn cpp_config() -> LanguageConfig {
    LanguageConfig {
        language: Language::Cpp, name: "C++".to_string(),
...
pub fn csharp_config() -> LanguageConfig {
    LanguageConfig {
        language: Language::CSharp, name: "C#".to_string(),
