...
pub fn swift_config() -> LanguageConfig {
    LanguageConfig {
        language: Language::Swift, name: "Swift".to_string(),
...
pub fn php_config() -> LanguageConfig {
    LanguageConfig {
        language: Language::Php, name: "PHP".to_string(),
...
pub fn ruby_config() -> LanguageConfig {
    LanguageConfig {
        language: Language::Ruby, name: "Ruby".to_string(),
...
pub fn bash_config() -> LanguageConfig {
    LanguageConfig {
        language: Language::Shell, name: "Bash".to_string(),
...
pub fn scala_config() -> LanguageConfig {
    LanguageConfig {
        language: Language::Scala, name: "Scala".to_string(),
...
pub fn dart_config() -> LanguageConfig {
    LanguageConfig {
        language: Language::Dart, name: "Dart".to_string(),
...
pub fn lua_config() -> LanguageConfig {
    LanguageConfig {
        language: Language::Lua, name: "Lua".to_string(),
...
pub fn r_config() -> LanguageConfig {
    LanguageConfig {
        language: Language::R, name: "R".to_string(),
...
pub fn perl_config() -> LanguageConfig {
    LanguageConfig {
        language: Language::Perl, name: "Perl".to_string(),
...
pub fn kotlin_config() -> LanguageConfig {
    LanguageConfig {
        language: Language::Kotlin, name: "Kotlin".to_string(),
...
pub fn sql_config() -> LanguageConfig {
    LanguageConfig {
        language: Language::Sql, name: "SQL".to_string(),
...
pub fn all_configs() -> Vec<LanguageConfig> {
    vec![
        rust_config(), python_config(), javascript_config(), typescript_config(),
        java_config(), go_config(), c_config(), cpp_config(), csharp_config(),
        swift_config(), php_config(), ruby_config(), bash_config(), scala_config(),
        dart_config(), lua_config(), r_config(), perl_config(), kotlin_config(), sql_config(),
    ]
}
