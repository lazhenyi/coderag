...
/// Extract C# symbols
pub fn extract_csharp(source: &[u8], node: tree_sitter::Node, file_path: &str, symbols: &mut Vec<crate::analyzer::Symbol>) {
    match node.kind() {
...
pub fn extract_swift(source: &[u8], node: tree_sitter::Node, file_path: &str, symbols: &mut Vec<crate::analyzer::Symbol>) {
    let symbol_kinds = [
