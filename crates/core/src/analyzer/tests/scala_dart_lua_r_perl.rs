...
"#;
    let result = parser
        .parse_with_language(scala_code.as_bytes(), Language::Scala)
        .unwrap();
...
"#;
    let result = parser
        .parse_with_language(dart_code.as_bytes(), Language::Dart)
        .unwrap();
    let symbols = analyzer.extract_symbols(
        dart_code.as_bytes(),
        &result.tree,
...
"#;
    let result = parser
        .parse_with_language(lua_code.as_bytes(), Language::Lua)
        .unwrap();
    let symbols = analyzer.extract_symbols(
        lua_code.as_bytes(),
        &result.tree,
...
"#;
    let result = parser
        .parse_with_language(r_code.as_bytes(), Language::R)
        .unwrap();
...
"#;
    let result = parser
        .parse_with_language(perl_code.as_bytes(), Language::Perl)
        .unwrap();
    let symbols = analyzer.extract_symbols(
        perl_code.as_bytes(),
        &result.tree,
