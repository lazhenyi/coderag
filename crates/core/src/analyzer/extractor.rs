...
use crate::analyzer::extractors::{
    extract_rust, extract_python, extract_go, extract_c, extract_cpp,
    extract_csharp, extract_swift, extract_javascript, extract_java,
    extract_php, extract_ruby, extract_bash,
};
...
impl SymbolExtractor {
    ...
    pub fn extract(
        ...
        match language {
            ...
            crate::parser::Language::Python => extract_python(source, root, file_path, &mut symbols),
            ...
            crate::parser::Language::CSharp => extract_csharp(source, root, file_path, &mut symbols),
            ...
            crate::parser::Language::Scala => extract_symbols_by_kind(source, root, &[
                ("function_definition", SymbolKind::Function),
                ("class_definition", SymbolKind::Class),
                ("trait_definition", SymbolKind::Trait),
                ("object_definition", SymbolKind::Class),
            ], file_path, &mut symbols),
            crate::parser::Language::Dart => extract_symbols_by_kind(source, root, &[
            ...
            crate::parser::Language::Lua => extract_symbols_by_kind(source, root, &[
                ("function_declaration", SymbolKind::Function),
            ], file_path, &mut symbols),
            crate::parser::Language::R => extract_symbols_by_kind(source, root, &[
                ("function_definition", SymbolKind::Function),
                ("class_definition", SymbolKind::Class),
            ], file_path, &mut symbols),
            crate::parser::Language::Perl => extract_symbols_by_kind(source, root, &[
                ("function", SymbolKind::Function),
                ("package", SymbolKind::Module),
                ("class", SymbolKind::Class),
            ], file_path, &mut symbols),
            crate::parser::Language::Kotlin => extract_symbols_by_kind(source, root, &[
                ("function_declaration", SymbolKind::Function),
                ("class_declaration", SymbolKind::Class),
                ("object_declaration", SymbolKind::Class),
                ("type_alias", SymbolKind::TypeAlias),
            ], file_path, &mut symbols),
            crate::parser::Language::Sql => extract_symbols_by_kind(source, root, &[
