...
//!
//! Evaluates Top1/Top5 retrieval accuracy for supported languages.
//! Designed to be run with a real Qdrant instance and real API keys.
...
pub async fn evaluate(
    queries: &[EvalQuery],
    storage: &coderag_storage::QdrantClient,
    embedder: &coderag_core::embedder::Embedder,
    ...
    for (i, query) in queries.iter().enumerate() {
        ...
        let options = coderag_storage::SearchOptions {
            limit: 5,
            filter: Some(coderag_storage::SearchFilter {
